...
function checkProductInDatabase($pdo, $aiData) {
    ...
    if (empty($userWarehouseId)) {
        error_log("⚠️ No warehouse_id for current user in api_ai_analyze.php");
        return $result;
    }
...
// Project hiện thống nhất dùng calculateEnhancedSimilarity() từ helpers/SimilarityHelper.php
