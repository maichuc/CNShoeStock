...
require_once __DIR__ . '/../Helpers/TroGiupPhanTichAI.php';
require_once __DIR__ . '/../Helpers/TroGiupDoTuongDong.php'; // Centralized normalization functions
require_once __DIR__ . '/../../app/Classes/GhepSanPhamThongMinh.php';
require_once __DIR__ . '/../Helpers/DichVuTaiAnhLen.php';
...
function analyzeSingle() {
    ...
    try {
        ...
        return [
            ...
            'processing_time_ms' => $processingTime,
            'ai_model' => env('GEMINI_MODEL', 'gemini-2.5-flash')
        ];
