...
// ===== TẤT CẢ CÁC HÀM AI ĐÃ ĐƯỢC CHUYỂN VÀO helpers/AIAnalysisHelper.php =====
// ===== TẤT CẢ CÁC HÀM SIMILARITY ĐÃ ĐƯỢC CHUYỂN VÀO helpers/SimilarityHelper.php =====
// ===== HÀM DUPLICATE DETECTION ĐÃ ĐƯỢC CHUYỂN VÀO enhanced_duplicate_functions.php =====
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <a href="danh_sach_sp.php" class="btn btn-primary btn-block">
                        ...
                        if (response.success) {
                            ...
                            setTimeout(() => {
                                $('#successActions').append(`
                                    <div class="col-md-6 mb-3">
                                        <a href="danh_sach_sp.php" class="btn btn-success btn-block">
                                            <i class="fas fa-list"></i> Xem danh sách sản phẩm
                                        </a>
                                    </div>
                                    <div class="col-md-6 mb-3">
