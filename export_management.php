            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card stats-card stats-completed shadow h-100 py-2 <?php echo $completedCount > 0 ? 'ready-to-ship' : ''; ?>" style="cursor: pointer;" onclick="window.location.href='confirm_delivery.php'">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                    ...
                    <div class="alert alert-info alert-dismissible fade show mb-4" role="alert">
                        ...
                        <a href="confirm_delivery.php" class="alert-link">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="action-buttons">
                                                ...
                                                <a href="process_export.php?export_id=<?php echo $export['export_id']; ?>" 
                                                   class="btn btn-sm btn-primary" title="Xử lý phiếu">
                                                    <i class="fas fa-tasks"></i> Xử lý
                                                </a>
                                                <?php endif; ?>
                                                
                                                <a href="view_export.php?export_id=<?php echo $export['export_id']; ?>" 
