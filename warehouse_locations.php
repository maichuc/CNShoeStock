...
<body id="page-top">
    ...
    <script>
        ...
        function saveBulkLocations() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: 'api_warehouse_locations.php?action=bulk_create',
                        type: 'POST',
        ...
        function loadWarehouses() {
            $.ajax({
                url: 'api_warehouse_locations.php?action=warehouses',
                type: 'GET',
                success: function(response) {
                    if (response.success) {
        ...
        function saveLocation() {
            ...
            $.ajax({
                url: 'api_warehouse_locations.php?action=create',
                type: 'POST',
                contentType: 'application/json',
                data: JSON.stringify(data),
                success: function(response) {
        ...
        function editLocation(locationId) {
            $.ajax({
                url: 'api_warehouse_locations.php?action=detail&location_id=' + locationId,
                type: 'GET',
                success: function(response) {
                    if (response.success) {
        ...
        function updateLocation() {
            ...
            $.ajax({
                url: 'api_warehouse_locations.php?action=update',
                type: 'PUT',
                contentType: 'application/json',
                data: JSON.stringify(data),
                success: function(response) {
        ...
        function deleteLocation(locationId, locationCode, warehouseId) {
            ...
            $.ajax({
                url: 'api_warehouse_locations.php?action=delete&location_id=' + locationId,
                type: 'DELETE',
                dataType: 'json',
                success: function(response) {
                    if (response.success) {
        ...
        function toggleStatus(locationId, isActive, locationCode) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: 'api_warehouse_locations.php?action=toggle_status',
                        type: 'PUT',
                        contentType: 'application/json',
                        data: JSON.stringify({
