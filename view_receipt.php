...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    header('Location: stock_receipts_management.php');
    exit();
}
            ...
            <li class="nav-item">
                ...
                <div id="collapseProducts" class="collapse" aria-labelledby="headingProducts" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="add_product_ai.php">Thêm sản phẩm</a>
                        <a class="collapse-item" href="danh_sach_sp.php">Danh sách sản phẩm</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseReceipts" class="collapse show" aria-labelledby="headingReceipts" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="stock_receipts_management.php">Quản lý phiếu nhập</a>
                    </div>
                </div>
            </li>
                        ...
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="stock_receipts_management.php">Quản lý phiếu nhập</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Chi tiết phiếu nhập</li>
                                </ol>
                            </nav>
                        </div>
                        <div>
                            <a href="stock_receipts_management.php" class="btn btn-secondary btn-sm">
