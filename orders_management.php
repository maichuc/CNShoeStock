...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="create_order.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                    ...
                    <form method="GET" class="filter-form">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <a href="orders_management.php" class="btn btn-secondary">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="order-actions">
                                                ...
                                                <a href="export_management.php" class="btn btn-sm btn-success" title="Xử lý đơn xuất kho">
                                                    <i class="fas fa-file-export"></i> Xử lý xuất kho
                                                </a>
                                                
                                                <!-- Các trạng thái khác -->
                                                <?php elseif ($order['status'] === 'waiting_delivery'): ?>
                                                <a href="update_delivery_status.php" class="btn btn-sm btn-status-waiting" title="Quản lý giao hàng">
    ...
    <script>
        ...
        function viewExportSlip(orderId) {
            window.open('export_slip.php?order_id=' + orderId, '_blank');
        }
            ...
            rows.forEach(row => {
                ...
                if (orderCell && orderCell.textContent.includes(String(orderId).padStart(6, '0'))) {
                    ...
                    if (actionsCell && newStatus === 'accepted') {
                        ...
                        exportBtn.onclick = () => window.open(`export_slip.php?order_id=${orderId}`, '_blank');
