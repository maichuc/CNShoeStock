...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="add_supplier.php" class="btn btn-add-supplier">
                            ...
                            <div class="card search-card mb-4">
                                <div class="card-body">
                                    <form method="GET" class="d-flex align-items-center">
                                        ...
                                        <div class="col-md-2 px-2">
                                            <a href="suppliers_management.php" class="btn btn-secondary btn-block">
                            ...
                            <div class="text-center py-5">
                                ...
                                <p class="text-gray-400">
                                    <?php if (!empty($search) || !empty($status)): ?>
                                        ...
                                        <br>
                                        <a href="suppliers_management.php" class="text-primary">Xem tất cả nhà cung cấp</a>
                                    <?php else: ?>
                                        Hãy thêm nhà cung cấp đầu tiên để bắt đầu quản lý.
                                        <br>
                                        <a href="add_supplier.php" class="btn btn-primary mt-3">
    ...
    <script>
        ...
        function editSupplier(supplierId) {
            window.location.href = `add_supplier.php?edit=${supplierId}`;
        }
