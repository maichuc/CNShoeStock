                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 text-right">
                                ...
                                <div id="customDatePicker" class="custom-date-picker" style="display: <?php echo $timePeriod == 'custom' ? 'block' : 'none'; ?>;">
                                    <form method="GET" action="index.php" class="form-inline mt-2">
                                ...
                                <div class="chart-card-header">
                                    ...
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <a class="dropdown-item" href="stock_receipts_management.php">Xem chi tiết</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="chart-card-header">
                                    ...
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <div class="dropdown-header">Tuỳ chọn:</div>
                                            <a class="dropdown-item" href="danh_sach_sp.php">Xem danh sách</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="chart-body">
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                        ...
                                        <?php endif; ?>
                                        <a href="danh_sach_sp.php?filter=low_stock" class="btn btn-warning btn-sm ml-2 text-white">
