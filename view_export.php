...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="export_management.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="process_export.php?export_id=<?php echo $exportId; ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-right">
                                <div class="action-buttons">
                                    <?php if (in_array($export['status'], ['pending', 'processing'])): ?>
                                    <a href="process_export.php?export_id=<?php echo $exportId; ?>" class="btn btn-primary">
                                    ...
                                    <a href="export_slip.php?order_id=<?php echo $export['order_id']; ?>" class="btn btn-success" target="_blank">
    ...
    function reprocessExport(exportId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Gửi request
                fetch('api_reprocess_export.php', {
                    method: 'POST',
                    headers: {
