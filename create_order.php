...
// error_log("DEBUG create_order.php - User ID: " . ($_SESSION['user_id'] ?? 'null') . ", Warehouse ID: " . ($userWarehouseId ?? 'null'));
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = response.redirect || 'orders_management.php?status=pending';
                        });
                    } else {
