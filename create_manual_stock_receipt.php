...
<body id="page-top">
    ...
    <script>
        ...
        function saveDraftReceipt() {
            ...
            $.ajax({
                url: 'api_save_manual_stock_receipt.php',
                method: 'POST',
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = 'stock_receipts_management.php?t=' + new Date().getTime();
                        });
                    } else {
                        Swal.fire({
                            icon: 'error',
