...
// ============================================
// LOAD HELPER FUNCTIONS TỪ api_ai_forecast.php
// ============================================

/**
 * Load functions từ api_ai_forecast.php mà KHÔNG chạy logic API
 * Set flag để api_ai_forecast.php biết là đang được include
 */
define('EXPORT_FORECAST_INCLUDE', true);

// Bỏ qua output từ api_ai_forecast.php
ob_start();
require_once 'api_ai_forecast.php';
ob_end_clean();

/**
 * Wrapper function để gọi getRestockSuggestions từ api_ai_forecast.php
 */
function exportGetRestockSuggestions($conn, $warehouse_id, $month, $region) {
    try {
        // Gọi trực tiếp hàm từ api_ai_forecast.php
...
/**
 * Wrapper function để gọi getLowStockSuggestions từ api_ai_forecast.php
 */
