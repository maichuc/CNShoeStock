                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center py-4">
                                ...
                                <p class="text-gray-400">
                                    ...
                                    <br>
                                    Vui lòng kiểm tra trang <a href="export_management.php" class="text-primary">Quản lý phiếu xuất kho</a> để xử lý các phiếu chưa hoàn thành.
                                </p>
                            </div>
                            <?php else: ?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="export-row-<?php echo $export['export_id']; ?>">
                                            ...
                                            <td class="action-buttons">
                                                ...
                                                <a href="export_slip.php?order_id=<?php echo $export['order_id']; ?>" 
        ...
        function cancelExport(exportId, exportCode) {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    ...
                    return fetch('api_confirm_delivery.php', {
                        method: 'POST',
                        headers: {
                ...
                if (result.isConfirmed && result.value) {
                    Swal.fire({
                        ...
                        if (buttonResult.isConfirmed) {
                            ...
                            window.location.href = 'orders_management.php';
                        } else {
