            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div>
                            <a href="helpers/generate_employee_template.php?generate=template" class="btn btn-success btn-sm mr-2">
    ...
    <script>
        ...
        function initializeDataTable() {
            employeeTable = $('#employeeTable').DataTable({
                "ajax": {
                    "url": "api_employee_management.php",
                    "type": "POST",
                    "data": function(d) {
        ...
        function editEmployee(userId) {
            $.ajax({
                url: 'api_employee_management.php?action=detail&user_id=' + userId,
                method: 'GET',
                success: function(response) {
                    if (response.success) {
