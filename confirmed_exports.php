            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="export_management.php" class="btn btn-sm btn-primary shadow-sm">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center py-5">
                                ...
                                <div class="mt-3">
                                    <a href="confirm_delivery.php" class="btn btn-primary">
                                        <i class="fas fa-check-circle mr-2"></i>Đi đến Xác nhận xuất hàng
                                    </a>
                                    <a href="export_management.php" class="btn btn-secondary">
