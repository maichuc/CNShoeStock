...
<body id="page-top">
    ...
    <script>
        ...
        function createRestockOrder(productId, quantity) {
            ...
            window.location.href = `api_stock_receipt_simple.php?product_id=${productId}&quantity=${quantity}`;
        }
        ...
        // Load Real AI Insights from inventory data (same as index.php)
        ...
        function exportForecastToExcel() {
            ...
            form.method = 'GET';
            form.action = 'api_export_forecast.php';
            form.target = '_blank';
