 ...
 * File: api_check_duplicates_manual.php
 */

session_start();
require_once 'config/database.php';
require_once 'helpers/SimilarityHelper.php'; // UNIFIED: Use shared similarity functions
...
function calculateManualSimilarity($inputData, $dbProduct) {
    ...
    // So sánh màu sắc - UNIFIED: Use shared function from SimilarityHelper.php
...
// Note: calculateTextSimilarity() is now imported from helpers/SimilarityHelper.php
// Note: calculateColorSimilarityEnhanced() and normalizeColorEnhanced() are in SimilarityHelper.php
