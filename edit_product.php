...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    header('Location: danh_sach_sp.php?error=invalid_id');
    exit();
}
...
if (!$product) {
    header('Location: danh_sach_sp.php?error=product_not_found_or_access_denied');
    exit();
}
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div>
                            <a href="view_product.php?id=<?php echo $product_id; ?>" class="btn btn-info btn-sm mr-2">
                                <i class="fas fa-eye"></i> Xem chi tiết
                            </a>
                            <a href="danh_sach_sp.php" class="btn btn-secondary btn-sm">
                                ...
                                <small class="form-text text-muted">Nhập hoặc chọn loại sản phẩm từ danh sách gợi ý</small>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-9 offset-sm-3">
                                                ...
                                                <a href="danh_sach_sp.php" class="btn btn-secondary ml-2">
    ...
    <script>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = 'view_product.php?id=<?php echo $product_id; ?>';
            }
        });
        <?php endif; ?>
